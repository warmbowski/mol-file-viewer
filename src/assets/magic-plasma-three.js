/**
 * Magic Plasma Sphere reference code by SaboSugi:
 * https://codepen.io/sabosugi/pen/jErWrMe
 */
...
folderPlasma
  ...
  .name("Texture Scale")
  .onChange((v) => (plasmaMat.uniforms.uScale.value = v));
folderPlasma
  .add(params, "plasmaBrightness", 0.5, 3.0)
  .name("Brightness")
  .onChange((v) => (plasmaMat.uniforms.uBrightness.value = v));
folderPlasma
  .add(params, "voidThreshold", 0.0, 0.8)
  .name("Voids")
  .onChange((v) => (plasmaMat.uniforms.uThreshold.value = v));
folderPlasma
  .addColor(params, "colorDeep")
  .name("Color Deep")
  .onChange((v) => plasmaMat.uniforms.uColorDeep.value.set(v));
folderPlasma
  .addColor(params, "colorMid")
  .name("Color Mid")
  .onChange((v) => plasmaMat.uniforms.uColorMid.value.set(v));
folderPlasma
  .addColor(params, "colorBright")
  .name("Color Bright")
  .onChange((v) => plasmaMat.uniforms.uColorBright.value.set(v));
...
folderShell
  ...
  .name("Edge Color")
  .onChange((v) => shellFrontMat.uniforms.uColor.value.set(v));
folderShell
  .add(params, "shellOpacity", 0.0, 1.0)
  .name("Edge Opacity")
  .onChange((v) => (shellFrontMat.uniforms.uOpacity.value = v));
